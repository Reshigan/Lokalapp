...
export default function CommissionsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-6">
      {/* Header */}
      <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 text-white p-6 pb-28 rounded-b-3xl">
        ...
        <Card className="bg-white/10 backdrop-blur border-0 text-white shadow-2xl">
          <CardContent className="p-5">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-emerald-200 text-sm">Available to Withdraw</p>
      ...
      <div className="px-4 -mt-14">
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg text-white">Recent Commissions</CardTitle>
          </CardHeader>
      ...
      <Dialog open={showWithdraw && !withdrawSuccess} onOpenChange={setShowWithdraw}>
        <DialogContent className="max-w-sm mx-4 bg-slate-800 border-slate-700">
          <DialogHeader>
            <DialogTitle className="text-white">Withdraw Commission</DialogTitle>
          </DialogHeader>
          <div className="py-4">
          ...
          <DialogFooter className="flex gap-2">
            <Button variant="outline" onClick={() => setShowWithdraw(false)} className="border-slate-600 text-slate-300 hover:bg-slate-700">
              Cancel
            </Button>
            <Button 

  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-6">
      ...
      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white p-6 rounded-b-[30px]">
        ...
        <div className="space-y-3">
          <div className="relative">
            <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-indigo-200" />
            <Input
              type="tel"
          ...
          <div className="relative">
            <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-indigo-200" />
            <Input
              type="text"
          ...
          <Button 
            className="w-full bg-white text-indigo-600 hover:bg-gray-50 shadow-lg"
      ...
      <div className="px-4 mt-4">
        ...
        <Button 
          variant="outline"
          className="w-full mb-4 border-gray-200 text-gray-600 hover:bg-gray-50 rounded-xl"
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                ...
                {customers.map((customer) => (
                  <Card key={customer.id} className="cursor-pointer hover:shadow-lg transition-shadow bg-white border-0 shadow-lg rounded-2xl">

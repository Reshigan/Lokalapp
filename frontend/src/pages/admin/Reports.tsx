        ...
        <div className="flex gap-2">
          {[7, 30, 90].map((days) => (
            <Button
              ...
              className={period === days ? 'bg-white text-red-700' : 'text-white hover:bg-white/20'}
            >
              {days} days
            </Button>
          ))}
                ...
                {topAgents.slice(0, 10).map((agent, index) => (
                  <div key={agent.agent_code} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium truncate">{agent.business_name}</p>
                    ...
                    <div className="text-right">
                      <p className="font-semibold">{formatCurrency(agent.total_sales)}</p>
                      <p className="text-xs text-gray-500">

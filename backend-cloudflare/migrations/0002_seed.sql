...
-- Flat tariff
INSERT INTO tariff_plans (id, name, description, type, billing_period, flat_rate_per_kwh, service_fee, is_active)
VALUES ('tar-flat', 'Flat Residential', 'R2.20/kWh, monthly', 'FLAT', 'MONTHLY', 2.20, 0, 1);

-- Stepped block tariff
INSERT INTO tariff_plans (id, name, description, type, billing_period, service_fee, is_active)
VALUES ('tar-stepped', 'Block Residential', '0-50 R1.50, 51-350 R2.20, 350+ R3.10', 'UNITS_BLOCK', 'MONTHLY', 15, 1);

INSERT INTO tariff_blocks (id, tariff_id, from_kwh, to_kwh, rate_per_kwh, sort_order) VALUES
...
INSERT INTO tariff_time_bands (id, tariff_id, name, start_hour, end_hour, rate_per_kwh, sort_order) VALUES
  ('tb-1', 'tar-tou', 'PEAK',     17, 21, 3.50, 1),
  ('tb-2', 'tar-tou', 'STANDARD',  6, 17, 2.20, 2),
  ('tb-3', 'tar-tou', 'OFF_PEAK', 21,  6, 1.20, 3);

-- Default community office
INSERT INTO community_offices (id, name, code, address, is_active)
VALUES ('off-main', 'Main Community Office', 'MAIN', 'Community Centre, Main Road', 1);

-- WiFi packages (kept from existing)
INSERT INTO wifi_packages (id, name, description, price, data_limit_mb, validity_hours, sort_order) VALUES
...
INSERT INTO electricity_packages (id, name, description, price, kwh_amount, package_type, sort_order) VALUES
